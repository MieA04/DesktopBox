...
function L(n3, l5, u4, t4, i4, r4, o4, e4, f4, c4, a4) {
  var s4, h4, p5, v4, y5, _4, g4, m5 = t4 && t4.__k || w, b4 = l5.length;
  for (f4 = T(u4, l5, m5, f4, b4), s4 = 0; s4 < b4; s4++) null != (p5 = u4.__k[s4]) && (h4 = -1 != p5.__i && m5[p5.__i] || d, p5.__i = s4, _4 = q(n3, p5, h4, i4, r4, o4, e4, f4, c4, a4), v4 = p5.__e, p5.ref && h4.ref != p5.ref && (h4.ref && J(h4.ref, null, p5), a4.push(p5.ref, p5.__c || v4, p5)), null == y5 && null != v4 && (y5 = v4), (g4 = !!(4 & p5.__u)) || h4.__k === p5.__k ? (f4 = j(p5, f4, n3, g4), g4 && h4.__e && (h4.__e = null)) : "function" == typeof p5.type && void 0 !== _4 ? f4 = _4 : v4 && (f4 = v4.nextSibling), p5.__u &= -7);
  return u4.__e = y5, f4;
}
function T(n3, l5, u4, t4, i4) {
  var r4, o4, e4, f4, c4, a4 = u4.length, s4 = a4, h4 = 0;
  for (n3.__k = new Array(i4), r4 = 0; r4 < i4; r4++) null != (o4 = l5[r4]) && "boolean" != typeof o4 && "function" != typeof o4 ? ("string" == typeof o4 || "number" == typeof o4 || "bigint" == typeof o4 || o4.constructor == String ? o4 = n3.__k[r4] = x(null, o4, null, null, null) : g(o4) ? o4 = n3.__k[r4] = x(S, { children: o4 }, null, null, null) : void 0 === o4.constructor && o4.__b > 0 ? o4 = n3.__k[r4] = x(o4.type, o4.props, o4.key, o4.ref ? o4.ref : null, o4.__v) : n3.__k[r4] = o4, f4 = r4 + h4, o4.__ = n3, o4.__b = n3.__b + 1, e4 = null, -1 != (c4 = o4.__i = O(o4, u4, f4, s4)) && (s4--, (e4 = u4[c4]) && (e4.__u |= 2)), null == e4 || null == e4.__v ? (-1 == c4 && (i4 > a4 ? h4-- : i4 < a4 && h4++), "function" != typeof o4.type && (o4.__u |= 4)) : c4 != f4 && (c4 == f4 - 1 ? h4-- : c4 == f4 + 1 ? h4++ : (c4 > f4 ? h4-- : h4++, o4.__u |= 4))) : n3.__k[r4] = null;
...
function q(n3, u4, t4, i4, r4, o4, e4, f4, c4, a4) {
  var s4, h4, p5, v4, y5, d4, _4, k4, x4, M2, $2, I2, P2, A4, H2, T5 = u4.type;
  if (void 0 !== u4.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f4 = u4.__e = t4.__e]), (s4 = l.__b) && s4(u4);
  n: if ("function" == typeof T5) try {
    if (k4 = u4.props, x4 = T5.prototype && T5.prototype.render, M2 = (s4 = T5.contextType) && i4[s4.__c], $2 = s4 ? M2 ? M2.props.value : s4.__ : i4, t4.__c ? _4 = (h4 = u4.__c = t4.__c).__ = h4.__E : (x4 ? u4.__c = h4 = new T5(k4, $2) : (u4.__c = h4 = new C(k4, $2), h4.constructor = T5, h4.render = Q), M2 && M2.sub(h4), h4.state || (h4.state = {}), h4.__n = i4, p5 = h4.__d = true, h4.__h = [], h4._sb = []), x4 && null == h4.__s && (h4.__s = h4.state), x4 && null != T5.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = m({}, h4.__s)), m(h4.__s, T5.getDerivedStateFromProps(k4, h4.__s))), v4 = h4.props, y5 = h4.state, h4.__v = u4, p5) x4 && null == T5.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), x4 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
    else {
      if (x4 && null == T5.getDerivedStateFromProps && k4 !== v4 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(k4, $2), u4.__v == t4.__v || !h4.__e && null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(k4, h4.__s, $2)) {
        u4.__v != t4.__v && (h4.props = k4, h4.state = h4.__s, h4.__d = false), u4.__e = t4.__e, u4.__k = t4.__k, u4.__k.some(function(n4) {
          n4 && (n4.__ = u4);
        }), w.push.apply(h4.__h, h4._sb), h4._sb = [], h4.__h.length && e4.push(h4);
        break n;
      }
      null != h4.componentWillUpdate && h4.componentWillUpdate(k4, h4.__s, $2), x4 && null != h4.componentDidUpdate && h4.__h.push(function() {
        h4.componentDidUpdate(v4, y5, d4);
      });
    }
    if (h4.context = $2, h4.props = k4, h4.__P = n3, h4.__e = false, I2 = l.__r, P2 = 0, x4) h4.state = h4.__s, h4.__d = false, I2 && I2(u4), s4 = h4.render(h4.props, h4.state, h4.context), w.push.apply(h4.__h, h4._sb), h4._sb = [];
    else do {
      h4.__d = false, I2 && I2(u4), s4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
    } while (h4.__d && ++P2 < 25);
    h4.state = h4.__s, null != h4.getChildContext && (i4 = m(m({}, i4), h4.getChildContext())), x4 && !p5 && null != h4.getSnapshotBeforeUpdate && (d4 = h4.getSnapshotBeforeUpdate(v4, y5)), A4 = null != s4 && s4.type === S && null == s4.key ? E(s4.props.children) : s4, f4 = L(n3, g(A4) ? A4 : [A4], u4, t4, i4, r4, o4, e4, f4, c4, a4), h4.base = u4.__e, u4.__u &= -161, h4.__h.length && e4.push(h4), _4 && (h4.__E = h4.__ = null);
  } catch (n4) {
...
function G(u4, t4, i4, r4, o4, e4, f4, c4, a4) {
  var s4, h4, p5, v4, y5, w5, _4, m5 = i4.props || d, k4 = t4.props, x4 = t4.type;
  if ("svg" == x4 ? o4 = "http://www.w3.org/2000/svg" : "math" == x4 ? o4 = "http://www.w3.org/1998/Math/MathML" : o4 || (o4 = "http://www.w3.org/1999/xhtml"), null != e4) {
    for (s4 = 0; s4 < e4.length; s4++) if ((y5 = e4[s4]) && "setAttribute" in y5 == !!x4 && (x4 ? y5.localName == x4 : 3 == y5.nodeType)) {
      u4 = y5, e4[s4] = null;
      break;
    }
  }
  ...
  if (null == x4) m5 === k4 || c4 && u4.data == k4 || (u4.data = k4);
    ...
    if (e4 = "textarea" == x4 && null != k4.defaultValue ? null : e4 && n.call(u4.childNodes), !c4 && null != e4) for (m5 = {}, s4 = 0; s4 < u4.attributes.length; s4++) m5[(y5 = u4.attributes[s4]).name] = y5.value;
    ...
    for (s4 in k4) y5 = k4[s4], "children" == s4 ? v4 = y5 : "dangerouslySetInnerHTML" == s4 ? h4 = y5 : "value" == s4 ? w5 = y5 : "checked" == s4 ? _4 = y5 : c4 && "function" != typeof y5 || m5[s4] === y5 || N(u4, s4, y5, m5[s4], o4);
...
// node_modules/.pnpm/@preact+signals@2.9.1_preact@10.29.2/node_modules/@preact/signals/dist/signals.module.js
var l4;
var d3;
var h3;
